...
# pipeline 默认测试规模（可用 --limit 覆盖；--limit 0 表示全量）
PIPELINE_DEFAULT_LIMIT = int(os.getenv("MOLTBOOK_PIPELINE_LIMIT", "200"))
PIPELINE_DEFAULT_FEEDS_LIMIT = int(os.getenv("MOLTBOOK_PIPELINE_FEEDS_LIMIT", "10"))
